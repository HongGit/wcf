...
namespace System.ServiceModel.Description
{
    ...
    {
        Collection<MetadataSection> _sections = new Collection<MetadataSection>();
        Collection<XmlAttribute> _attributes = new Collection<XmlAttribute>();

        //internal ServiceMetadataExtension.WriteFilter _writeFilter;
        ...
        void WriteMetadataSet(XmlWriter writer, bool processOuterElement)
        {
            ...
            //TODO
            //if (_writeFilter != null)
            //{
            //    ServiceMetadataExtension.WriteFilter filter = _writeFilter.CloneWriteFilter();
            //    filter._writer = writer;
            //    writer = filter;
            //}
            MetadataSetSerializer xs = new MetadataSetSerializer
            {
